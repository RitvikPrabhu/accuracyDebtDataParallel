...
@dataclass
class DistributedWGANTrainerDefaults:
    id: str = "DistributedWGANTrainer"
...
@register_with_hydra(
    group="trainer",
    defaults=DistributedWGANTrainerDefaults,
    name="distributed_wgan_trainer",
)
class DistributedWGANTrainer:
