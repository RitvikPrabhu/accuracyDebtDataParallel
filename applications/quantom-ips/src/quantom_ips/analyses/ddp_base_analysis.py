...
@dataclass
class DDPBaseAnalysisDefaults:
    id: str = "DDPBaseAnalysis"
...
@register_with_hydra(group="analysis", defaults=DDPBaseAnalysisDefaults, name="ddp_base_analysis")
class DDPBaseAnalysis:
    """
    DDP-friendly analogue of DistributedBaseAnalysis without MPI dependencies.
    """
    ...
    def __init__(self, config, devices, dtype):
        ...
        # Only rank 0 writes artifacts; torch.distributed is initialized in the driver.
    ...
    def forward(
        ...
        # Mirror the interface of DistributedBaseAnalysis.
        if is_online:
